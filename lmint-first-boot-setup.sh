...
##### Install software #####
sudo apt-get install -qy deluge sublime-text git filezilla plank vimix-flat-themes spotify-client bleachbit netbeans gufw trimage imagemagick nodejs* numix-theme numix-plank-theme
